...
export class CodeToken extends Inline {
...
export default class Syntax extends Module {
  ...
  initListener() {
    this.quill.on(Events.SCROLL_BLOT_MOUNT, blot => {
  ...
  highlight(blot = null, force = false) {
    ...
    this.quill.update(Sources.SILENT)
    if (range != null) {
...
export { SyntaxCodeBlock as CodeBlock }
